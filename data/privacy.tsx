...
export const securityRetention = [
  {
    id: "s1",
    title: "Security and Retention Procedures at OTA",
    description: [
      {
        id: 1,
        title:
          "We have measures in place to prevent unauthorized access and misuse of your personal data. We use appropriate business systems, security procedures, and technical and physical restrictions to protect and safeguard your information. Only authorized personnel can access personal data.",
      },
      {
        id: 2,
        title:
      ...
      },
      {
        id: 3,
        title:
          "We value your trust in providing us with your Personal Information, and we are using commercially acceptable means of protecting it. We are cautious, however, that no method of transmission over the Internet, or method of electronic storage is 100% secure and reliable, and we cannot guarantee its absolute security.",
      },
    ],
  },
  {
    ...
    description: [
      ...
      },
      {
        id: 3,
        title:
          "The foregoing information collected from the users/customers/travelers is put to the following use:",
      },
      {
        id: 4,
        title:
          "Customer name, address, phone number, traveler's name, and age are shared with applicable service providers like airlines, hotels, etc., for the purpose of reservation and booking the services for the customer/traveler.",
      },
      {
        id: 5,
        title:
  ...
  },
  {
    ...
    description: [
      ...
      },
      {
        id: 2,
        title:
          "We may update our Privacy Policy from time to time. Thus, you are advised to review this page periodically. We will notify you of any changes by posting the new Privacy Policy on this page. These changes are effective immediately after they are posted on the page.",
      },
    ],
  },
];
