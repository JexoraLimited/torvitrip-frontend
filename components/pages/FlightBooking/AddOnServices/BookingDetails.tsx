import blueRobbin from "@/assets/images/icons/robbin_bags.png";
...
const BookingDetails = () => {
  ...
  const [baggageTaken, setBaggageTaken] = useState(true);
  return (
        ...
        <div className="flex flex-col gap-y-4 cursor-pointer">
          <div className="w-full">
            ...
            >
              <div className="flex items-center gap-3">
                <div
                  onClick={() => setBaggageTaken(true)}
                  className={cn(
                    "flex-1 p-4 rounded-lg border border-border bg-slate-100",
                    baggageTaken && "border-secondary bg-secondary/10"
                  )}
                >
                  <Image
                    src={blueRobbin}
                ...
                <div className="w-full mt-5">
                  <div className="w-full divide-y rounded-lg border border-border">
                    <div className="flex items-stretch divide-x">
                      <div className="flex-1 py-3 px-4 h-full bg-slate-100">
                    ...
                    <div className="flex items-stretch divide-x">
                      <div className="flex-1 py-3 px-4 bg-slate-100">
                        <h5 className="font-semibold text-sm">SMS Tracking</h5>
                      </div>
                      <div className="flex-1 py-3 px-4 bg-slate-50">
                        <MdClose className="text-red-500 text-xl mx-auto block" />
                      </div>
